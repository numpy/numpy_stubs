...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    @overload
    def all(
        self, axis: None = ..., out: None = ..., keepdims: Optional[bool] = ...
    ) -> bool_: ...
    @overload
    def all(
        self, axis: int, out: Optional[ndarray] = ..., keepdims: Optional[bool] = ...
    ) -> ndarray: ...
    @overload
    def any(
        self, axis: None = ..., out: None = ..., keepdims: Optional[bool] = ...
    ...
    @overload
    def argmax(self, axis: None = ..., out: Optional[ndarray] = ...) -> integer: ...
    @overload
    def argmax(self, axis: int, out: Optional[ndarray] = ...) -> ndarray: ...
    @overload
    def argmin(self, axis: None = ..., out: Optional[ndarray] = ...) -> integer: ...
    @overload
    def argmin(self, axis: int, out: Optional[ndarray] = ...) -> ndarray: ...
    def argpartition(
        self,
        axis: Optional[int] = ...,
        kind: str = ...,
        order: Optional[Union[str, List[str]]] = ...,
    ) -> ndarray: ...
    def argsort(
        self,
        axis: Optional[int] = ...,
    ...
    def diagonal(
        self, offset: int = ..., axis: int = ..., axis2: int = ...
    ) -> ndarray: ...
