...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    # Shape manipulation
    @overload
    def reshape(self, shape: _ShapeLike, order: str=...) -> ndarray: ...
    @overload
    def reshape(self,
                __dim1: int,
                __dim2: int,
    ...
    @overload
    def transpose(self, axes: _ShapeLike) -> ndarray: ...
    @overload
    def transpose(self, __axis1: int, __axis2: int, *axes: int) -> ndarray: ...
    def swapaxes(self, axis1: int, axis2: int) -> ndarray: ...
    def flatten(self, order: str=...) -> ndarray: ...
    def ravel(self, order: str=...) -> ndarray: ...
    def squeeze(self, axis: _ShapeLike=...) -> ndarray: ...
