...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    @overload
    def itemset(self, __value: Any): ...
    @overload
    def itemset(self, __item: _ShapeLike, __value: Any): ...
    def tostring(self, order: str=...) -> bytes: ...
    def tobytes(self, order: str=...) -> bytes: ...
    def tofile(self, fid: Union[IO[Any], str], sep: str, format: str): ...
    ...
    def view(self,
             dtype: Union[_DtypeLike, Type[ndarray]]=...,
             type: Type[ndarray]=...) -> ndarray: ...
    def getfield(self,
                 dtype: Union[_DtypeLike, str],
                 offset: int=...) -> ndarray: ...
    def setflags(self, write: bool=..., align: bool=..., uic: bool=...): ...
