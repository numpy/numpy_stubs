...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    def argmin(self) -> Any: ...
    @overload
    def argmin(self, axis: int, out: ndarray=...) -> Any: ...
    @overload
    def max(self, *, keepdims: bool=...) -> Any: ...
    @overload
    def max(self, axis: int, out: ndarray=..., keepdims: bool=...) -> Any: ...
    @overload
    def min(self, *, keepdims: bool=...) -> Any: ...
    @overload
    ...
    @overload
    def clip(self, __a_min: _ArrayLike[Any], out: ndarray=...) -> ndarray: ...
    @overload
    def clip(self, __a_min: None, __a_max: _ArrayLike[Any], out: ndarray=...) -> ndarray: ...
    @overload
    def clip(self, __a_min: _ArrayLike[Any], __a_max: None, out: ndarray=...) -> ndarray: ...
    @overload
    def clip(self, __a_min: _ArrayLike[Any], __a_max: _ArrayLike[Any], out: ndarray=...) -> ndarray: ...
