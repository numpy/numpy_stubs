...
class _real_generic(generic, metaclass=ABCMeta):
    @property
    def real(self: _ArraySelf) -> _ArraySelf: ...
    @property
    def imag(self: _ArraySelf) -> _ArraySelf: ...

class number(generic, metaclass=ABCMeta): ...
...
class integer(number, _real_generic, metaclass=ABCMeta): ...
class signedinteger(integer, metaclass=ABCMeta): ...
...
class unsignedinteger(integer, metaclass=ABCMeta): ...
...
class inexact(number, metaclass=ABCMeta): ...
class floating(inexact, _real_generic, metaclass=ABCMeta): ...
...
class complexfloating(inexact, metaclass=ABCMeta): ...
