...
class generic:
    ...
    @property
    def imag(self: _Scalar) -> _Scalar: ...
    @imag.setter
    def imag(self: _Scalar) -> _Scalar: ...

    @property
    def T(self: _Scalar) -> _Scalar: ...
    ...
    def __copy__(self: _Scalar, order: str = ...) -> _Scalar: ...
    def __deepcopy__(self: _Scalar, memo: dict) -> _Scalar: ...
